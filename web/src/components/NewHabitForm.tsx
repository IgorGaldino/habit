...
export function NewHabitForm() {
  ...
  async function onCreateNewHabit(event: FormEvent) {
  ...
  function handleToggleWeekDay(weekDayIndex: number) {
    if (weekDays.includes(weekDayIndex)) {
      const weekDaysWithRemoveOne = weekDays.filter(
  ...
  return (
    <form onSubmit={onCreateNewHabit} className="w-full flex flex-col mt-6">
